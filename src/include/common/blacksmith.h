 ...
 *  @param f_payload[in] This function must return a Packet struct with pkt_pointer containing the pointer to the payload data. If null p_arg wil be used as payload
