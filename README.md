...
<br/>
  ...
  `-p, --amport=am_port       Amplifier port (Se omitido porta padrão ataque)`<br/>  
  `-r, --timer=timer          Tempo de execução em minutos (Se omitido tempo padrão)`<br/>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMjg1MDQzNywtMTk4MDE4MzQ2MCwxOD
